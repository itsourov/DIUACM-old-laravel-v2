...
!function() {
    ...
    const i = Array.prototype.indexOf
        , l = (e, t) => {
        return n = e,
            r = t,
        i.call(n, r) > -1;
    ...
    const u = /[&<>"']/
        , h = new RegExp(u.source,"g")
        , p = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/
        , g = new RegExp(p.source,"g")
        , f = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
    ...
    const m = /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi
        , x = /(^|[^\[])\^/g;
    function b(e, t) {
        e = "string" == typeof e ? e : e.source,
            t = t || "";
        const n = {
            replace: (t, r) => (r = (r = "object" == typeof r && "source"in r ? r.source : r).replace(x, "$1"),
                e = e.replace(t, r),
                n),
    ...
    class T {
        ...
        list(e) {
            ...
            if (t) {
                ...
                s.items[s.items.length - 1].raw = l.trimEnd(),
        ...
        table(e) {
            ...
            if (t) {
                ...
                if (e.header.length === e.align.length) {
                    ...
                    for (i = e.rows.length,
                             t = 0; t < i; t++)
                        e.rows[t] = _(e.rows[t], e.header.length).map((e => ({
                            text: e,
                            tokens: []
                        })));
        ...
        inlineText(e) {
            ...
            if (t) {
                let e;
                return e = this.lexer.state.inRawBlock ? t[0] : k(t[0]),
                    {
                        type: "text",
                        raw: t[0],
                        text: e
    ...
    v.def = b(v.def).replace("label", v._label).replace("title", v._title).getRegex(),
        v.bullet = /(?:[*+-]|\d{1,9}[.)])/,
        v.listItemStart = b(/^( *)(bull) */).replace("bull", v.bullet).getRegex(),
        v.list = b(v.list).replace(/bull/g, v.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + v.def.source + ")").getRegex(),
        v._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",
        v._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/,
        v.html = b(v.html, "i").replace("comment", v._comment).replace("tag", v._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),
        v.lheading = b(v.lheading).replace(/bull/g, v.bullet).getRegex(),
        v.paragraph = b(v._paragraph).replace("hr", v.hr).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", v._tag).getRegex(),
        ...
        v.gfm.table = b(v.gfm.table).replace("hr", v.hr).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", " {4}[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", v._tag).getRegex(),
        v.gfm.paragraph = b(v._paragraph).replace("hr", v.hr).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", v.gfm.table).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", v._tag).getRegex(),
        v.pedantic = {
            ...v.normal,
    ...
    R.punctuation = b(R.punctuation, "u").replace(/punctuation/g, R._punctuation).getRegex(),
        R.blockSkip = /\[[^[\]]*?\]\([^\(\)]*?\)|`[^`]*?`|<[^<>]*?>/g,
        R.anyPunctuation = /\\[punct]/g,
        R._escapes = /\\([punct])/g,
        R._comment = b(v._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex(),
        R.emStrong.lDelim = b(R.emStrong.lDelim, "u").replace(/punct/g, R._punctuation).getRegex(),
        R.emStrong.rDelimAst = b(R.emStrong.rDelimAst, "gu").replace(/punct/g, R._punctuation).getRegex(),
        R.emStrong.rDelimUnd = b(R.emStrong.rDelimUnd, "gu").replace(/punct/g, R._punctuation).getRegex(),
        R.anyPunctuation = b(R.anyPunctuation, "gu").replace(/punct/g, R._punctuation).getRegex(),
        R._escapes = b(R._escapes, "gu").replace(/punct/g, R._punctuation).getRegex(),
        ...
        R.autolink = b(R.autolink).replace("scheme", R._scheme).replace("email", R._email).getRegex(),
        R._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/,
        R.tag = b(R.tag).replace("comment", R._comment).replace("attribute", R._attribute).getRegex(),
        R._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,
        R._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/,
        R._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,
        R.link = b(R.link).replace("label", R._label).replace("href", R._href).replace("title", R._title).getRegex(),
        R.reflink = b(R.reflink).replace("label", R._label).replace("ref", v._label).getRegex(),
        R.nolink = b(R.nolink).replace("ref", v._label).getRegex(),
        R.reflinkSearch = b(R.reflinkSearch, "g").replace("reflink", R.reflink).replace("nolink", R.nolink).getRegex(),
        R.normal = {
            ...R
        },
        R.pedantic = {
            ...
            link: b(/^!?\[(label)\]\((.*?)\)/).replace("label", R._label).getRegex(),
            reflink: b(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", R._label).getRegex()
        },
        R.gfm = {
            ...R.normal,
            escape: b(R.escape).replace("])", "~|])").getRegex(),
        ...
        R.gfm.url = b(R.gfm.url, "i").replace("email", R.gfm._extended_email).getRegex(),
        R.breaks = {
            ...R.gfm,
            br: b(R.br).replace("{2,}", "*").getRegex(),
            text: b(R.gfm.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
        };
    class S {
        tokens;
        options;
        ...
        constructor(e) {
            ...
            this.options.pedantic ? (t.block = v.pedantic,
                t.inline = R.pedantic) : this.options.gfm && (t.block = v.gfm,
        ...
        parse(e, t=!0) {
            ...
            for (let r = 0; r < e.length; r++) {
                ...
                switch (s.type) {
                    ...
                    {
                        const e = s;
                        n += this.renderer.heading(this.parseInline(e.tokens), e.depth, this.parseInline(e.tokens, this.textRenderer).replace(m, ( (e, t) => "colon" === (t = t.toLowerCase()) ? ":" : "#" === t.charAt(0) ? "x" === t.charAt(1) ? String.fromCharCode(parseInt(t.substring(2), 16)) : String.fromCharCode(+t.substring(1)) : "")));
                        continue
                    }
                    case "code":
                    {
                    ...
                    case "list":
                    {
                        ...
                        for (let t = 0; t < e.items.length; t++) {
                            ...
                            o += this.parse(n.tokens, i),
                                l += this.renderer.listitem(o, s, !!r)
                        }
                        n += this.renderer.list(l, t, r);
                        continue
                    }
                    case "html":
                    {
    ...
    class D {
        ...
        parse = this.#e(S.lex, C.parse);
        parseInline = this.#e(S.lexInline, C.parseInline);
        Parser = C;
        Renderer = E;
        TextRenderer = z;
        Lexer = S;
        ...
        use(...e) {
            ...
            return e.forEach((e => {
                    ...
                    if (e.tokenizer) {
                        const t = this.defaults.tokenizer || new T(this.defaults);
                    ...
                    if (e.hooks) {
                        const t = this.defaults.hooks || new I;
                        for (const n in e.hooks) {
                            const r = e.hooks[n]
                                , s = n
                                , i = t[s];
                            I.passThroughHooks.has(n) ? t[s] = e => {
        ...
        lexer(e, t) {
            return S.lex(e, t ?? this.defaults)
        }
        parser(e, t) {
    ...
    O.options = O.setOptions = function(e) {
        ...
        O.walkTokens = function(e, t) {
            return N.walkTokens(e, t)
        }
        ,
        O.parseInline = N.parseInline,
        O.Parser = C,
        O.parser = C.parse,
        O.Renderer = E,
        O.TextRenderer = z,
        ...
        C.parse,
        S.lex;
    var B = ["ADDRESS", "ARTICLE", "ASIDE", "AUDIO", "BLOCKQUOTE", "BODY", "CANVAS", "CENTER", "DD", "DIR", "DIV", "DL", "DT", "FIELDSET", "FIGCAPTION", "FIGURE", "FOOTER", "FORM", "FRAMESET", "H1", "H2", "H3", "H4", "H5", "H6", "HEADER", "HGROUP", "HR", "HTML", "ISINDEX", "LI", "MAIN", "MENU", "NAV", "NOFRAMES", "NOSCRIPT", "OL", "OUTPUT", "P", "PRE", "SECTION", "TABLE", "TBODY", "TD", "TFOOT", "TH", "THEAD", "TR", "UL"];
    function P(e) {
        return Z(e, B)
    }
    ...
    U.paragraph = {
            ...
            replacement: function(e, t, n) {
                ...
                if ("OL" === s.nodeName) {
                    var i = s.getAttribute("start")
                        , l = Array.prototype.indexOf.call(s.children, t);
                    r = (i ? Number(i) + l : l + 1) + ".  "
                }
        ...
        U.fencedCodeBlock = {
            ...
            replacement: function(e, t, n) {
                for (var r, s = ((t.firstChild.getAttribute("class") || "").match(/language-(\S+)/) || [null, ""])[1], i = t.firstChild.textContent, l = n.fence.charAt(0), o = 3, a = new RegExp("^" + l + "{3,}","gm"); r = a.exec(i); )
        ...
        U.referenceLink = {
            ...
            replacement: function(e, t, n) {
                var r, s, i = t.getAttribute("href"), l = j(t.getAttribute("title"));
                switch (l && (l = ' "' + l + '"'),
        ...
        U.image = {
            filter: "img",
            replacement: function(e, t) {
                var n = j(t.getAttribute("alt"))
                    , r = t.getAttribute("src") || ""
                    , s = j(t.getAttribute("title"));
                return r ? "![" + n + "](" + r + (s ? ' "' + s + '"' : "") + ")" : ""
            }
        },
        Q.prototype = {
            ...
            forNode: function(e) {
                return e.isBlank ? this.blankRule : (t = V(this.array, e, this.options)) || (t = V(this._keep, e, this.options)) || (t = V(this._remove, e, this.options)) ? t : this.defaultRule;
                var t
            },
            forEach: function(e) {
    ...
    var Y, W, J, ee = "undefined" != typeof window ? window : {}, te = function() {
        var e = ee.DOMParser
            , t = !1;
        try {
        ...
        return t
    }() ? ee.DOMParser : (Y = function() {}
        ,
        W = {},
        Y.prototype.parseFromString = function(e) {
            return W.createDocument(e)
        }
        ,
        Y);
    function ne(e, t) {
        ...
        return function(e) {
            ...
            ;
            if (t.firstChild && !s(t)) {
                for (var i = null, l = !1, o = null, a = X(o, t, s); a !== t; ) {
                    if (3 === a.nodeType || 4 === a.nodeType) {
                        var c = a.data.replace(/[ \r\n\t]+/g, " ");
                        if (i && !/ $/.test(i.data) || l || " " !== c[0] || (c = c.substr(1)),
                            !c) {
                            a = K(a);
                            continue
                        }
            ...
            element: n = "string" == typeof e ? (J = J || new te).parseFromString('<x-turndown id="turndown-root">' + e + "</x-turndown>", "text/html").getElementById("turndown-root") : e.cloneNode(!0),
            isBlock: P,
            isVoid: q,
            isPre: t.preformattedCode ? re : null
        }),
            n
    }
    function re(e) {
    ...
    function se(e, t) {
        return e.isBlock = P(e),
            ...
            e.flankingWhitespace = function(e, t) {
                ...
                return r.leadingAscii && ie("left", e, t) && (r.leading = r.leadingNonAscii),
                r.trailingAscii && ie("right", e, t) && (r.trailing = r.trailingNonAscii),
                    {
                        leading: r.leading,
                        trailing: r.trailing
                    }
    ...
    function ie(e, t, n) {
        ...
        return "left" === e ? (r = t.previousSibling,
            s = / $/) : (r = t.nextSibling,
            s = /^ /),
        r && (3 === r.nodeType ? i = s.test(r.nodeValue) : n.preformattedCode && "CODE" === r.nodeName ? i = !1 : 1 !== r.nodeType || P(r) || (i = s.test(r.textContent))),
            i
    }
    var le = Array.prototype.reduce
        , oe = [[/\\/g, "\\\\"], [/\*/g, "\\*"], [/^-/g, "\\-"], [/^\+ /g, "\\+ "], [/^(=+)/g, "\\$1"], [/^(#{1,6}) /g, "\\$1 "], [/`/g, "\\`"], [/^~~~/g, "\\~~~"], [/\[/g, "\\["], [/\]/g, "\\]"], [/^>/g, "\\>"], [/_/g, "\\_"], [/^(\d+)\. /g, "$1\\. "]];
    function ae(e) {
    ...
    function ce(e) {
        var t = this;
        return le.call(e.childNodes, (function(e, n) {
                var r = "";
                return 3 === (n = new se(n,t.options)).nodeType ? r = n.isCode ? n.nodeValue : t.escape(n.nodeValue) : 1 === n.nodeType && (r = he.call(t, n)),
                    pe(e, r)
            }
        ), "")
    }
    function ue(e) {
        ...
        return this.rules.forEach((function(n) {
                "function" == typeof n.append && (e = pe(e, n.append(t.options)))
            }
        )),
            e.replace(/^[\t\r\n]+/, "").replace(/[\t\r\n\s]+$/, "")
    }
    ...
    ae.prototype = {
        turndown: function(e) {
            ...
            if ("" === e)
                return "";
            var t = ce.call(this, new ne(e,this.options));
    ...
    const ge = e => {
        ...
        , ke = (e, t) => {
            ...
            const n = "TinyPlugin" + t.nameAddition
                , r = new RegExp(`${t.startMarker || ":"}(${o(e).map(de).join("|")})${t.endMarker || ":"}`)
        ...
        , xe = (t, n) => {
            const r = t.converterToHtml.parse(n, {
                async: !1
            });
            if (e(r))
                return r;
    ...
    ;
    tinymce.PluginManager.add("markdown", (i => {
            (e => {
            ...
            const o = (e => {
                    ...
                    return t.use({
                        ...
                        (e => new Promise(( (t, r) => {
                                const i = () => {
                                        e.plugins.emoticons && n(e.plugins.emoticons.getAllEmojis) ? e.plugins.emoticons.getAllEmojis().then((e => {
                                                const n = {};
                                                (e => {
                        ...
                        )))(e).then((e => e.each((e => t.use(e))))).catch(r).then((l = {
                            converterToHtml: t,
                            converterFromHtml: i
                        },
                            () => l));
            ...
            return ( (t, n) => {
                    t.addCommand("MarkdownInsert", ( (r, s) => {
                            e(s) && n.then((e => {
                                    t.undoManager.add(),
                                        t.undoManager.extra(( () => t.execCommand("mceInsertClipboardContent", !1, {
                                            text: s
                                        })), ( () => t.insertContent(xe(e, s)))),
                                        (e => {
                ...
                o.then((e => (i.on("paste", (n => {
                        n.isDefaultPrevented() || i.queryCommandState("mceTogglePlainTextPaste") || ( (e, n) => n.isDefaultPrevented() || t(n.clipboardData) || l(n.clipboardData.types, "text/html") ? s.none() : l(n.clipboardData.types, "text/plain") ? ( (e, t) => xe(e, t) === t ? s.none() : s.some(t))(e, n.clipboardData.getData("text/plain")) : s.none())(e, n).each((e => {
                                n.preventDefault(),
                                    i.execCommand("MarkdownInsert", !1, e),
                                    (e => {
                    ...
                    e))),
                {
                    getContent: () => o.then((e => ( (e, t) => e.converterFromHtml.turndown(t))(e, i.getContent())))
                }
        }
    ))
}();
