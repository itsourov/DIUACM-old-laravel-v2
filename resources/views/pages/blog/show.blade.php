    ...
    <div class="py-16">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-5xl mx-auto">
                {{-- Back button --}}
                <div class="mb-6">
                    <a href="{{ route('blog.index') }}" class="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium">
                ...
                {{-- Content --}}
                <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 md:p-8 shadow-md border border-slate-200 dark:border-slate-700 mb-8">
                    <div class="prose prose-slate dark:prose-invert prose-headings:font-semibold prose-a:text-blue-600 dark:prose-a:text-blue-400 prose-img:rounded-xl max-w-none">
                        {!! $blog->content !!}
                    </div>
                </div>

                {{-- Share links --}}
                <div class="bg-slate-100 dark:bg-slate-800/50 rounded-xl p-6 shadow-inner border border-slate-200 dark:border-slate-700">
                ...
                <div class="mt-16">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-md border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-shadow">
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-slate-600 dark:text-slate-400">{{ $post->published_at->format('M d, Y') }}</span>
                                    <a href="{{ route('blog.show', $post->slug) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-sm font-medium">Read more</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
