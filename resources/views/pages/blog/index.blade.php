        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12 text-center">
                ...
                <p class="text-lg text-slate-600 dark:text-slate-300 max-w-xl mx-auto">
                    Stay updated with the latest news, tutorials, and insights from our competitive programming community
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach($posts as $post)
                    <div class="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-md border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-shadow">
                        ...
                        @endif
                        <div class="p-6">
                            <span class="text-sm text-slate-600 dark:text-slate-400 mb-4 block">{{ $post->published_at->format('M d, Y') }}</span>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('blog.show', $post->slug) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-sm font-medium flex items-center gap-1">
                                    Read more
