<header class="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 shadow-sm sticky top-0 z-40">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <nav class="hidden md:ml-6 md:flex md:space-x-6">
                ...
                <a href="{{ route('event.index') }}" class="{{ request()->is('events') || request()->is('events/*') ? 'text-blue-600 dark:text-blue-400' : 'text-slate-700 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400' }} font-medium">Events</a>
                ...
                <a href="{{ route('tracker.index') }}" class="{{ request()->is('trackers') || request()->is('trackers/*') ? 'text-blue-600 dark:text-blue-400' : 'text-slate-700 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400' }} font-medium">Trackers</a>
    ...
    <div class="md:hidden hidden" id="mobile-menu">
        <div class="px-2 pt-2 pb-3 space-y-1 bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700">
            ...
            <a href="{{ route('event.index') }}" class="{{ request()->is('events') || request()->is('events/*') ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700' }} block px-3 py-2 rounded-md font-medium">Events</a>
            ...
            <a href="{{ route('tracker.index') }}" class="{{ request()->is('trackers') || request()->is('trackers/*') ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700' }} block px-3 py-2 rounded-md font-medium">Trackers</a>
